...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Clipper_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1721f0f4-5627-55cb-8b31-c466f04189fe"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Clipper", artifacts_toml) for e in artifacts["Clipper"]]
...
if best_platform === nothing
    @debug("Unable to load Clipper; unsupported platform $(triplet(platform_key_abi()))")
else
